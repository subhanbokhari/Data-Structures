...
void merge(int arr[], int left, int mid, int right)
{
    ...
    int rightSize = right - mid; // sub arrays sizes

    int leftArr[leftSize];
    int rightArr[rightSize]; // subarrays

    for (int i = 0; i < leftSize; i++)
    {
        leftArr[i] = arr[left + i];
    } // copyarr data to subarray data
    ...
    // comparing and sorting both subarr together
